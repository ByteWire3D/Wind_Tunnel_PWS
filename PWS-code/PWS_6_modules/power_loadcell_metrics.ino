...
void loop() {
  ...
  if ((newDataReady)) {
    ...
    if (current_millis != previous_millis) {
      mah_consumed += avrg_amp * 1000;
      mah_used += mah_consumed / 3600 * (1000 /loop_time);
    }
    ...
    avrg_count++;
    avrg_volt = busvoltage / avrg_count;
    avrg_amp = current_A / avrg_count;
    avrg_watt = wattage / avrg_count;
    avrg_lift = lift_value / avrg_count;
    avrg_drag = drag_value / avrg_count;
  }
